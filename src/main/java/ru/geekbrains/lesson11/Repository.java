...
public class Repository<T> {
    ...
    private final Statement deleteByIdStatement;
    ...
    public Repository(Class<T> repositoryClass, Connection connection) throws SQLException {
        ...
        this.deleteByIdStatement = connection.createStatement();
    }
    ...
    public void update(String userName, String password, Long id) throws SQLException {
        updateByIdStatement = connection.prepareStatement(
                "UPDATE user SET user_name = ?, password = ? WHERE id = ?");

        updateByIdStatement.setString(1,userName);
        updateByIdStatement.setString(2,password);
        updateByIdStatement.setLong(3, id);

        updateByIdStatement.executeUpdate();
    }

    public void delete(Long id) throws SQLException {
        deleteByIdStatement.executeUpdate("DELETE FROM USER where id = " + id);
    }
